...
public class TransactionHandler(AppDbContext context) : ITransactionHandler
{
    ...
    {
        // Parse to negative value if is Withdraw
        ...
        try
        {
            ...
            return new Response<Transaction?>(transaction, 201, "Transação salva com sucesso.");
        }
        catch
        {
            return new Response<Transaction?>(null, 500, "Erro ao salvar a transação.");
        }
    }
    ...
    public async Task<Response<Transaction?>> DeleteAsync(DeleteTransactionRequest request)
    {
        ...
        {
            return new Response<Transaction?>(null, 500, "Erro ao deletar a transação.");
        }
    }
    ...
    public async Task<Response<Transaction?>> UpdateAsync(UpdateTransactionRequest request)
    {
        ...
        {
            return new Response<Transaction?>(null, 500, "Erro ao atualizar a transação.");
        }
    }
}
